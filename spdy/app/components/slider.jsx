...
export default function Slider() {
    ...
    return (
      <div className="relative w-full h-[80vh] sm:h-[800px] mx-auto overflow-hidden">
        <div
        ...
        <button
          ...
          className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full text-sm sm:text-lg"
        >
          &#10094;
        </button>
        ...
        <button
          ...
          className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full text-sm sm:text-lg"
        >
          &#10095;
        </button>
